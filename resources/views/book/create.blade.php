...
@section('page_content')
    <div class="ui container">
        ...
        <form class="ui form {{ $errors->any() ? 'error' : '' }}" action="{{ route('book.store') }}" method="POST" enctype="multipart/form-data">
            <div class="ui grid">
                <div class="four wide computer column">
                    <input type="file" name="picture" class="dropify" data-default-file=""
